...
local ConvarClass = {}
ConvarClass.HookLabel = "TTT2RoleChangeDeagleHookLabel"
ConvarClass.UlxLabel = "TTT2RoleChangeDeagleUlxLabel"
...
--Role Change Deagle ConVars
local role_change_deagle_cfg = ConvarGroup("Role Change Deagle", "Role Change Deagle for TTT2")
Convar(role_change_deagle_cfg, false, "ttt2_role_change_deagle_refill_time", "15", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "How many seconds should it take for the Role Change Deagle to refill if it fails (<=0 to not refill at all)?", "int", 0, 120, 0)
Convar(role_change_deagle_cfg, false, "ttt2_role_change_deagle_ammo", "3", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "How much ammo should the Role Change Deagle have?", "int", 1, 6, 0)
Convar(role_change_deagle_cfg, false, "ttt2_role_change_allow_same", "0", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "Can the Role Change Deagle be used multiple times on the same player in a round?", "bool", 0, 1, 0)
